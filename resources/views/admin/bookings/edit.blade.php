<x-app-layout>
    ...
    <div class="pb-24 pt-4 px-2 max-w-xl mx-auto md:max-w-5xl">
            ...
            <div class="md:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex flex-col justify-between">
                ...
                <form action="{{ route('bookings.payment.store', $booking->id) }}" method="POST" class="bg-emerald-50 p-3 rounded-xl border border-emerald-100">
                    ...
                    <div class="flex gap-2 items-end">
                        <div class="flex-1">
                            <label class="text-[10px] font-bold text-emerald-800 uppercase block mb-1">Nominal (Rp)</label>
                            <input type="number" name="amount" placeholder="0" class="w-full text-sm rounded-lg border-emerald-200 focus:ring-emerald-500 py-2" required>
                        </div>
                        <div class="flex-1">
                            <label class="text-[10px] font-bold text-emerald-800 uppercase block mb-1">Ket.</label>
                            <input type="text" name="description" placeholder="DP/Lunas" class="w-full text-sm rounded-lg border-emerald-200 focus:ring-emerald-500 py-2" required>
                        </div>
                        <button type="submit" class="bg-emerald-600 text-white p-2.5 rounded-lg hover:bg-emerald-700 transition shadow-sm" title="Simpan Pembayaran">
        ...
        <form action="{{ route('bookings.update', $booking->id) }}" method="POST" class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-5 space-y-4">
                    <div class="bg-yellow-50 p-4 rounded-xl border border-yellow-200">
                        <label class="block text-xs font-bold text-yellow-800 uppercase mb-1">💰 Total Harga Deal (Rp)</label>
                        <input type="number" name="total_price" value="{{ $booking->total_price }}" class="w-full rounded-xl border-yellow-300 text-lg font-bold text-gray-800 focus:ring-yellow-500 focus:border-yellow-500" placeholder="Masukkan harga deal...">
                        <p class="text-[10px] text-gray-500 mt-1">*Ubah nominal ini untuk update sisa tagihan.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="booker_phone" value="{{ $booking->booker_phone }}" class="w-full mt-1 rounded-xl border-gray-300 text-sm focus:ring-emerald-500">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2 mt-1">
                            <input type="url" name="location_gmaps" value="{{ $booking->location_gmaps }}" placeholder="https://maps.google.com/..." class="w-full rounded-xl border-gray-300 text-sm focus:ring-emerald-500 text-blue-600">
            ...
            <button type="submit" class="w-full bg-emerald-900 text-white font-bold py-4 rounded-2xl shadow-lg hover:bg-emerald-800 transition transform active:scale-95 text-lg">
